...
count = int(input("Number of values> ")) # int(input("Number of values?> "))
min_value = int(input("Minimum values> "))# int(input("Minimum value?> "))
max_value = int(input("Maximum value> ")) # int(input("Maximum value?> "))
